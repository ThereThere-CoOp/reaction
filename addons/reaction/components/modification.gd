...
func setup(database: ReactionDatabase, parent_object: Resource, modification: ReactionContextModification, index: int, component_id: String, is_new_criteria: bool = false) -> void:
